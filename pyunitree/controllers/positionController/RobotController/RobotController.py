...
class Robot(object):
    def __init__(self, body, legs, imu, time_step,stateHandler):
        self.body = body
        self.legs = legs
    ...
    def updateImuOrientation(self):
        self.state.imu_roll = self.stateHandler.imuRoll
        self.state.imu_pitch = self.stateHandler.imuPitch
